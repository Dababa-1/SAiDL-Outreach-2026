...
def full_forward(x, w, b, gamma=None, beta=None, bn_param=None, dropout_param=None, last=False):
  bn_cache, ln_cache, relu_cache, dropout_cache = None, None, None, None

  # affine forward -> optional norm -> relu -> dropout 
  ...
  if not last:
        ...
        # has mode (train | test), it's batchnorm(since in batchnorm we need to know whether we should use running means/vars or not), otherwise, it's layernorm
        ...
        out, relu_cache = relu_forward(out) #relu
