...
class FullyConnectedNet(object):
    ...
    def loss(self, X, y=None):
        ...
        for l in range(self.num_layers):
            ...
            bn = self.bn_params[l] if gamma is not None else None  # bn params
            do = self.dropout_param if self.use_dropout else None  # do params

            X, cache[l] = full_forward(X, w, b, gamma, beta, bn, do, l==self.num_layers-1) # full_forward pass : implemented in the layer_utils
        ...
        for l in reversed(range(self.num_layers)):
            dout, dW, db, dgamma, dbeta = full_backward(dout, cache[l])
