...
class ThreeLayerConvNet(object):
    ...
    def __init__(
        ...
        self.params.update({
            'W1': np.random.randn(F, C, filter_size, filter_size) * weight_scale, # filter shapes
            'b1': np.zeros(num_filters),                                        # number of filters
            'W2': np.random.randn(F * H * W // 4, hidden_dim) * weight_scale,   #  reduced pool output
            'b2': np.zeros(hidden_dim),                                        #  number of hidden nodes
            'W3': np.random.randn(hidden_dim, num_classes) * weight_scale,     #  hiddden and output nodes
            'b3': np.zeros(num_classes),                                         # output nodes
        })
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
    ...
    def loss(self, X, y=None):
        ...
        scores, cache3 = full_forward(out, W3, b3, last=True) 
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dout, grads['W3'], grads['b3'], _, _ = full_backward(dout, cache3)    # first backward pass
